...
export const GUIDE_BLOCK_SCHEMA_HINT = {
  ...
  faq: { type: 'faq', items: [{ question: 'evaluation question without best/top ranking language', answer: '65-85 English words for BUYER_GUIDE' }] },
}
...
export const buyerGuideContentRules = {
  ...
  requirements: [
    'Target 2,400-2,600 English editorial words. Hard validator range is 2,200-2,800 words; do not draft around 2,050 words.',
    'Target 17-22 bodyJson.blocks, depending on selectedTools count, and never exceed 22 blocks.',
    'Use this required block plan in order: key_takeaways, problem_frame, Introduction section, Who This Guide Is For section, framework, one tool_callout for each selected tool, decision_tree, Workflow section, Common Mistakes section, Final Recommendation section, methodology, and faq.',
    'Do not merge introduction and audience guidance. They must be two separate section blocks.',
    'Include at least 6 meaningful framework criteria.',
    'Use every selected tool as a distinct tool_callout block; each verdict must be 110-130 words.',
    'Introduction section heading must contain Introduction or Overview; write 120-170 words and naturally include targetKeyword.',
    'Who section heading must contain Who This Guide Is For or Who It Is For; write 120-170 words and clearly cover primaryAudience and secondaryAudience.',
    'Each normal section must contain 120-170 words. Final Recommendation section must contain 130-170 words. Each FAQ answer must contain 65-85 words.',
    ...
    'Do not use these forbidden words or phrases: perfect, guaranteed, always, never, 100%, flawless, ultimate, best possible. Use strong fit, suitable fit, good option, likely, may, can help, often, generally, rarely, highly, or largely instead.',
